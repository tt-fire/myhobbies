        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form autocomplete="off" action="/hobby/{{ $hobby->id }}" method="post" enctype="multipart/form-data" {{-- enctype = für DAteien! --}}>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-2">
                            @if(file_exists("img/hobby/" . $hobby->id . "_gross.jpg"))
                                <img style="max-with: 400px; max-height: 300px;" src="/img/hobby/{{ $hobby->id }}_gross.jpg" alt="thumb">
                                <div class="float-right"><a class="btn btn-sm btn-outline-danger" href="/delete-image/hobby/{{ $hobby->id }}">Bild löschen</a></div>
                            @endif
                        </div>
